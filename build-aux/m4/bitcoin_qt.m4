  ...
  if test "x$bitcoin_qt_got_major_vers" = x5; then
     ...
     m4_ifdef([PKG_CHECK_MODULES],[
       ...
       if test "x$TARGET_OS" = xwindows; then
         ...
         QT_LIBS="$QT_LIBS -lQt5AccessibilitySupport -lQt5DeviceDiscoverySupport -lQt5EdidSupport -lQt5EventDispatcherSupport -lQt5FbSupport -lQt5FontDatabaseSupport -lQt5ThemeSupport -lQt5WindowsUIAutomationSupport -lqtlibpng -lqtharfbuzz -lqtpcre2 -ldwmapi"
       fi
     fi
  else
    if test "x$qt_plugin_path" != x; then
