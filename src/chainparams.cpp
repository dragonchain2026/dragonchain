...
// Create genesis block with custom timestamp for MAINNET
static CBlock CreateGenesisBlockWithCustomTimestamp(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    const char* pszTimestamp = "Dragonchain launched on 5 May 2026";
    const CScript genesisOutputScript = CScript() << ParseHex("04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f") << OP_CHECKSIG;
    return CreateGenesisBlock(pszTimestamp, genesisOutputScript, nTime, nNonce, nBits, nVersion, genesisReward);
}
...
public:
    CMainParams() {
        ...
        // First half year: 10,500,000 coins
        // Then every 4 years: subsidy halved
        consensus.nSubsidyHalvingInterval = 25228800; // 4 years
        ...
        */
        ...
        consensus.defaultAssumeValid = uint256S("3c9761d390215d5e51843db7802845052ad8bdfad2014050b9cc6b82337089c2");
        ...
        // New genesis block - Dragonchain fresh start
        // nTime: 1777900800 (2026-05-04 21:20:00 CST)
        // nNonce: 45 (found by find_nonce_yespower, yespower PoW)
        // genesisReward: pow(2,32) / COIN = 42.94967296
        genesis = CreateGenesisBlockWithCustomTimestamp(1777900800, 45, 0x1f3fffff, 1, 42.94967296 * COIN);

        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("3c9761d390215d5e51843db7802845052ad8bdfad2014050b9cc6b82337089c2"));
        assert(genesis.hashMerkleRoot == uint256S("79d2d2cf340893bc0f5df7cc596ba52fa979727f759f8feef347268414ff5fac"));
        assert(genesis.GetPoWHash() == uint256S("002a78bb14180180e6be535a5588f9cf8030dba42dc220de2fb1198dff23b265"));
        ...
        vSeeds.emplace_back("seed1.dragonchain.cc");
        vSeeds.emplace_back("seed2.dragonchain.cc");
        vSeeds.emplace_back("seed3.dragonchain.cc");
        vSeeds.emplace_back("seed4.dragonchain.cc");
        ...
        bech32_hrp = "dragon";   // bech32: starting with dragon1q
...
public:
    CTestNetParams() {
        ...
        */
        ...
        consensus.defaultAssumeValid = uint256S("0011c1b75e58f52852b1e3cb849466fdad337da591e40acabf4edd74bc901fa6");
        ...
        genesis = CreateGenesisBlock(1671337119, 1698268, 0x1f3fffff, 1, 42.94967296 * COIN);

        // added by sg, temporary
        // consensus.hashGenesisBlock = uint256S("0x01");
        consensus.hashGenesisBlock = uint256S("0011c1b75e58f52852b1e3cb849466fdad337da591e40acabf4edd74bc901fa6");
        // if (true && UintToArith256(genesis.GetHash()) != UintToArith256(consensus.hashGenesisBlock))
        if (false && UintToArith256(genesis.GetHash()) != UintToArith256(consensus.hashGenesisBlock))
        {
            std::cout << "recalculating params for testnet" << "\n";
            std::cout << "old testnet genesis nonce: " << genesis.nNonce << "\n";
            std::cout << "old testnet genesis hash: " << consensus.hashGenesisBlock.GetHex() << "\n";
            // deliberately empty for loop finds nonce value.
            for(genesis.nNonce = 0; UintToArith256(genesis.GetHash()) > UintToArith256(consensus.powLimit) || UintToArith256(genesis.GetPoWHash()) > UintToArith256(consensus.powLimit); genesis.nNonce++){ } 
            std::cout << "new testnet genesis merkle root: " << genesis.hashMerkleRoot.GetHex() << "\n";
            std::cout << "new testnet genesis nonce: " << genesis.nNonce << "\n";
            std::cout << "new testnet genesis hash: " << genesis.GetHash().GetHex() << "\n";
            std::cout << "new testnet genesis pow hash: " << genesis.GetPoWHash().GetHex() << "\n";
        ...
        // assert(genesis.GetPoWHash() == uint256S("002cbcb1c692975fd4c0dc9d5438b38239b609de6fd962d97c76cb2e3509c55c"));
        // assert(consensus.hashGenesisBlock == uint256S("0011c1b75e58f52852b1e3cb849466fdad337da591e40acabf4edd74bc901fa6"));
        // assert(genesis.hashMerkleRoot == uint256S("4d5d10fa6e5a26a2872cde3a4e018a52e2a4c806cb0747c9ee0327cbd8e60f8c"));
        ...
        checkpointData = {
            {
                // {0, uint256S("0x001")},
                {0, uint256S("0011c1b75e58f52852b1e3cb849466fdad337da591e40acabf4edd74bc901fa6")},
            }
        };
...
public:
    CRegTestParams() {
        ...
        */
        ...
        consensus.defaultAssumeValid = uint256S("00dfd941229d2c79720259ea3c39625af6dcdea6f6305cf76acf06af04df3e5f");
        ...
        genesis = CreateGenesisBlock(1671337119, 931, 0x200f0f0f, 1, 42.94967296 * COIN);

        // added by sg, temporary to minning genesis block to get params, etc: nnonce, nbits, hash, mercleroot
        // consensus.hashGenesisBlock = uint256S("0x01");
        consensus.hashGenesisBlock = uint256S("00dfd941229d2c79720259ea3c39625af6dcdea6f6305cf76acf06af04df3e5f");
        // if (true && UintToArith256(genesis.GetHash()) != UintToArith256(consensus.hashGenesisBlock))
        if (false && UintToArith256(genesis.GetHash()) != UintToArith256(consensus.hashGenesisBlock))
        {
            std::cout << "recalculating params for regnet" << "\n";
            std::cout << "old regnet genesis nonce: " << genesis.nNonce << "\n";
            std::cout << "old regnet genesis hash: " << consensus.hashGenesisBlock.GetHex() << "\n";
            // deliberately empty for loop finds nonce value.
            for(genesis.nNonce = 0; UintToArith256(genesis.GetHash()) > UintToArith256(consensus.powLimit) || UintToArith256(genesis.GetPoWHash()) > UintToArith256(consensus.powLimit); genesis.nNonce++){ } 
            std::cout << "new regnet genesis merkle root: " << genesis.hashMerkleRoot.GetHex() << "\n";
            std::cout << "new regnet genesis nonce: " << genesis.nNonce << "\n";
            std::cout << "new regnet genesis hash: " << genesis.GetHash().GetHex() << "\n";
            std::cout << "new regnet genesis pow hash: " << genesis.GetPoWHash().GetHex() << "\n";
            // LogPrintf("new mainnet genesis hash: %s\n", genesis.GetHash().ToString().c_str());
        }
        ...
        // assert(genesis.hashMerkleRoot == uint256S("7677ce2a579cb0411d1c9e6b1e9072b8f537f1e59cb387dacac2daac56e150b0"));
        // assert(genesis.GetPoWHash() == uint256S("074bdbae97267bccb3b80dc4de82602d34bb6689f63a2c2177ffa6bd0068bd15"));
        // assert(consensus.hashGenesisBlock == uint256S("00dfd941229d2c79720259ea3c39625af6dcdea6f6305cf76acf06af04df3e5f"));
        // assert(genesis.hashMerkleRoot == uint256S("4d5d10fa6e5a26a2872cde3a4e018a52e2a4c806cb0747c9ee0327cbd8e60f8c"));
        ...
        checkpointData = {
            {
                // {0, uint256S("0x001")},
                {0, uint256S("00dfd941229d2c79720259ea3c39625af6dcdea6f6305cf76acf06af04df3e5f")},
            }
        };
