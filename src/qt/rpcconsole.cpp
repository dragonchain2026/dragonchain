    ...
    consoleFontSize(0)
{
    ...
    // Create Mining page and embed it in the Mining tab
    miningPage = new MiningPage(this);
    QVBoxLayout *miningLayout = new QVBoxLayout(ui->tab_mining);
    miningLayout->setContentsMargins(0, 0, 0, 0);
    miningLayout->addWidget(miningPage);
}
...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if (miningPage) {
        miningPage->setClientModel(model);
    }
