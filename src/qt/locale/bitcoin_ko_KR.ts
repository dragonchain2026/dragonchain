...
<context>
    ...
    <message>
        <source>These are your Dragonchain addresses for sending payments. Always check the amount and the receiving address before sending coins.</source>
        <translation>슈가체인을 보내는 계좌 주소입니다. 코인을 보내기 전에 잔고와 받는 주소를 항상 확인하세요.</translation>
    </message>
    <message>
        <source>These are your Dragonchain addresses for receiving payments. It is recommended to use a new receiving address for each transaction.</source>
...
<context>
    ...
    <message>
        <source>Send coins to a Dragonchain address</source>
    ...
    <message>
        <source>Sign messages with your Dragonchain addresses to prove you own them</source>
        <translation>지갑 주소가 본인 소유인지 증명하기 위해 슈가체인 주소에 서명할 수 있습니다.</translation>
    </message>
    <message>
        <source>Verify messages to ensure they were signed with specified Dragonchain addresses</source>
    ...
    <message>
        <source>Request payments (generates QR codes and dragonchain: URIs)</source>
    ...
    <message>
        <source>Open a dragonchain: URI or payment request</source>
        <translation>dragonchain: URI 또는 지불요청 열기</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        <source>%n active connection(s) to Dragonchain network</source>
    ...
    <message>
        <source>Show the %1 help message to get a list with possible Dragonchain command-line options</source>
    ...
    <message>
        <source>A fatal error occurred. Dragonchain can no longer continue safely and will quit.</source>
...
<context>
    ...
    <message>
        <source>The entered address "%1" is not a valid Dragonchain address.</source>
...
<context>
    ...
    <message>
        <source>%1 will download and store a copy of the Dragonchain block chain.</source>
        <translation>%1은 Dragonchain 블록 체인의 사본을 다운로드하여 저장합니다.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <source>Recent transactions may not yet be visible, and therefore your wallet's balance might be incorrect. This information will be correct once your wallet has finished synchronizing with the dragonchain network, as detailed below.</source>
    ...
    <message>
        <source>Attempting to spend dragonchains that are affected by not-yet-displayed transactions will not be accepted by the network.</source>
...
<context>
    ...
    <message>
        <source>Automatically open the Dragonchain client port on the router. This only works when your router supports UPnP and it is enabled.</source>
        <translation>라우터에서 Dragonchain 클라이언트 포트를 자동적으로 엽니다. 라우터에서 UPnP를 지원하고 활성화 했을 경우에만 동작합니다.</translation>
    </message>
    <message>
    ...
    <message>
        <source>Connect to the Dragonchain network through a SOCKS5 proxy.</source>
    ...
    <message>
        <source>Connect to the Dragonchain network through a separate SOCKS5 proxy for Tor hidden services.</source>
...
<context>
    ...
    <message>
        <source>The displayed information may be out of date. Your wallet automatically synchronizes with the Dragonchain network after a connection is established, but this process has not completed yet.</source>
...
<context>
    ...
    <message>
        <source>Cannot start dragonchain: click-to-pay handler</source>
    ...
    <message>
        <source>URI cannot be parsed! This can be caused by an invalid Dragonchain address or malformed URI parameters.</source>
...
<context>
    ...
    <message>
        <source>Enter a Dragonchain address (e.g. %1)</source>
...
<context>
    ...
    <message>
        <source>An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the Dragonchain network.</source>
...
<context>
    ...
    <message>
        <source>Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for dragonchain transactions than the network can process.</source>
    ...
    <message>
        <source>Warning: Invalid Dragonchain address</source>
...
<context>
    ...
    <message>
        <source>The Dragonchain address to send the payment to</source>
    ...
    <message>
        <source>The fee will be deducted from the amount being sent. The recipient will receive less dragonchains than you enter in the amount field. If multiple recipients are selected, the fee is split equally.</source>
    ...
    <message>
        <source>A message that was attached to the dragonchain: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Dragonchain network.</source>
...
<context>
    ...
    <message>
        <source>You can sign messages/agreements with your addresses to prove you can receive dragonchains sent to them. Be careful not to sign anything vague or random, as phishing attacks may try to trick you into signing your identity over to them. Only sign fully-detailed statements you agree to.</source>
    ...
    <message>
        <source>The Dragonchain address to sign the message with</source>
    ...
    <message>
        <source>Sign the message to prove you own this Dragonchain address</source>
    ...
    <message>
        <source>The Dragonchain address the message was signed with</source>
        <translation>메세지의 서명에 사용된 슈가체인 주소</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified Dragonchain address</source>
