...
private:
    ...
    int64_t m_last_confirmation_update;
...
public Q_SLOTS:
    ...
    /** Batch flush all queued transaction notifications with bulk insert */
    void flushQueuedNotifications();
    /** Retry wallet refresh if initial load was blocked by locks */
    void refreshWallet();
