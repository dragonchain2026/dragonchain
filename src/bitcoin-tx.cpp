...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s dragonchain-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dragonchain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dragonchain transaction") + "\n" +
              "  dragonchain-tx [options] -create [commands]   " + _("Create hex-encoded dragonchain transaction") + "\n" +
              "\n";
